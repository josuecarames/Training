...
csv_file = '/Users/josuecarames/Documents/Code/Ruby/3.2_csv/sample_course_provisioning.csv' # use full file path to sample_course_provisioning.csv eg: '/path/to/file/sample_course_provisioning.csv'
