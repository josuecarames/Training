...
canvas_url = 'https://fuller.test.instructure.com' # please use your test or beta environments for practice
canvas_token = '9261~bhBjdSV7pAwvrxtCRWmsciEFPX43LU8ZNww2ErIzZWMBce0DRjiDsarKCe68QZpT'
csv_file = '/Users/josuecarames/Documents/Code/Ruby/Assignments/api_courses.csv'
success_count = 0
fail_count = 0
